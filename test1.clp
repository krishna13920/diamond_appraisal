...
(defrule get-diamond-details
   =>
   (printout t "what is the color of the diamond?-----" crlf "possible answers" crlf "(D- Blue white, E- Fine White ,F-White,G-Commercial white,H-Top Silver Cape,I-Cape) " crlf)
   (bind ?diamond-color (read))
   (printout t "what is the clarity of the diamond?" crlf "possible answers" crlf "(IF- Internally flawless, VVS- very very slightly included, VS- very slightly included, SI- slightly included) "crlf)
   (bind ?diamond-clarity (read))
   (printout t "what is the cut of the diamond?" crlf "possible answers (round, semi-round, square) " crlf)
   (bind ?diamond-cut (read))
   (printout t "what is the weight of the diamond in carats ?" crlf "Please round the hundreths place to 5 or 0 " crlf "example answers (0.5, 1.25 please enter 1.20 if it is 1.23 and below and 1.25 if its more) " crlf)
...
(printout t "The value of the diamond with the given specifications is---$" ?value crlf))
